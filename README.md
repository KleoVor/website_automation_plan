...
### 7.	Тестирование формы записи на курс «Тестировщик ПО» на сайте https://netology.ru/ по адресу https://netology.ru/programs/qa#/order *позитивный сценарий*: 
...
### 8.	Тестирование формы записи на курс «Тестировщик ПО» на сайте https://netology.ru/ по адресу https://netology.ru/programs/qa#/order *позитивный сценарий*: 
...
### 9.	Тестирование формы записи на курс «Тестировщик ПО» на сайте https://netology.ru/ по адресу https://netology.ru/programs/qa#/order *позитивный сценарий*: 
...
### 10.	Тестирование формы записи на курс «Тестировщик ПО» на сайте https://netology.ru/ по адресу https://netology.ru/programs/qa#/order *позитивный сценарий*: 
...
### 11.	Тестирование формы записи на курс «Тестировщик ПО» на сайте https://netology.ru/ по адресу https://netology.ru/programs/qa#/order *позитивный сценарий*: 
...
### 12.	Тестирование формы записи на курс «Тестировщик ПО» на сайте https://netology.ru/ по адресу https://netology.ru/programs/qa#/order *позитивный сценарий*: 
...
### 13.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
### 14.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
### 15.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
### 16.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
### 17.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
### 18.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
### 19.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ « “*.<br>
...
### 20.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ » “*.<br>
...
### 21.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ ; “*.<br>
...
### 22.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ % “*.<br>
...
### 23.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ : “*.<br>
...
### 24.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ ? “*.<br>
...
### 25.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ * “*.<br>
...
### 26.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ ( “*.<br>
...
### 27.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ ( “*.<br>
...
### 28.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ ) “*.<br>
...
### 29.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ = “*.<br>
...
### 30.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ ` “*.<br>
...
### 31.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ ~ “*.<br>
...
### 32.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ @ “*.<br>
...
### 33.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ # “*.<br>
...
### 34.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ $ “*.<br>
...
### 35.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ ^ “*.<br>
...
### 36.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ & “*.<br>
...
### 37.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ + “*.<br>
...
### 38.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ < “*.<br>
...
### 39.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ > “*.<br>
...
### 40.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ \ “*.<br>
...
### 41.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ | “*.<br>
...
### 42.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*поле «Имя» содержит символ “ / “*.<br>
...
### 43.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
### 44.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
### 45.	Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
46. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
47. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
48. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
49. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
50. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
51. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
52. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
53. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
54. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘№’ *.<br>
...
55. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘;’ *.<br>
...
56. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘%’ *.<br>
...
57. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘:’ *.<br>
...
58. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘&’ *.<br>
...
59. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘*’ *.<br>
...
*Ожидаемое поведение:* под полем «Телефон» появилось сообщение «Номер в формате +9 (999) 999-99-99», кнопка «Записаться» не активна, данные не отправляются.<br>
60. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘(’ *.<br>
...
61. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘)’ *.<br>
...
62. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘-’ *.<br>
...
63. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
64. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘=’ *.<br>
...
65. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘+’ *.<br>
...
66. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘@’ *.<br>
...
67. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘#’ *.<br>
...
68. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘$’ *.<br>
...
69. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘^’ *.<br>
...
70. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘&’ *.<br>
...
71. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘\’ *.<br>
...
72. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘|’ *.<br>
...
73. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘/’ *.<br>
...
74. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘>’ *.<br>
...
75. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘ ' ’ *.<br>
...
76. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘ . ’ *.<br>
...
77. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
*ввод в поле «Телефон» символ ‘ , ’ *.<br>
...
78. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
79. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
80. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
81. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
82. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
83. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
84. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
85. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *негативный сценарий*: 
...
86. Тестирование формы записи на курс «Тестировщик ПО» по адресу https://netology.ru/programs/qa#/order *позитивный сценарий*: 
